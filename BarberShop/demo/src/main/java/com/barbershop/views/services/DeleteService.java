...
public class DeleteService implements Initializable {
    ...
    //add product button
    public void delete() {
        DeleteData.DeleteService(Services.selectedService.getServiceId());
        closeWindow();
    }
    ...
    //display the wizard
    public static void openDeleteServiceWizard() {
        try {
            // Load the FXML file
            FXMLLoader fxmlLoader = new FXMLLoader(DeleteService.class.getResource("/com/barbershop/" + "DeleteService_Wizard.fxml"));
            ...
            stage.getIcons().add(new Image(AddService.class.getResourceAsStream("/com/barbershop/images/service.png")));            stage.setScene(scene);
