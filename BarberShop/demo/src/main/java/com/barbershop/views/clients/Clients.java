...
public class Clients implements Initializable {
	...
	@FXML private TableColumn<Client, String> firstName;
	@FXML private TableColumn<Client, String> lastName;
	@FXML private TableColumn<Client, Integer> phone;
    @FXML private TextField searchField;
    @FXML private ListView<Client> selectionList;
