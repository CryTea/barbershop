...
public class EditEvent implements Initializable {
    ...
    public void addEvent() {
        if (!PaternController.isValidName(clientFirstNameField.getText()) || !PaternController.isValidName(clientLastNameField.getText()) || !PaternController.isValidPhoneNumber(clientPhoneField.getText())){
            ...
            //create a new client if it do not exist
            ...
            for (Client c : GetData.AllClients) {
                if (c.getFirst_name().toLowerCase() == clientFirstNameField.getText().toLowerCase() && c.getLast_name().toLowerCase() == clientLastNameField.getText().toLowerCase() && c.getPhone() == Integer.parseInt(clientPhoneField.getText().toLowerCase())){
                    found = true;
                    break;
                }
            }
        ...
        // Get the selected hour from the Spinner for hour selection
        ...
        if (newEvent != null) {
            ...
            for (Event e : GetData.AllEvents) {
                if (e.getDateTime().equals(newEvent.getDateTime()) && e.getEventId() != Calendar.selectedEvent.getEventId()){
                    hasConflict = true;
                    break;
                }
            }
