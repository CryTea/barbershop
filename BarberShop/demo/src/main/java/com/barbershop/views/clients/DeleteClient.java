...
public class DeleteClient implements Initializable {
    ...
    //add product button
    public void delete() {
        DeleteData.DeleteClient(Clients.selectedClient.getClient_id());
        closeWindow();
    }
    ...
    //display the wizard
    public static void openDeleteClientWizard() {
        try {
            // Load the FXML file
            FXMLLoader fxmlLoader = new FXMLLoader(DeleteClient.class.getResource("/com/barbershop/" + "DeleteClient_Wizard.fxml"));
