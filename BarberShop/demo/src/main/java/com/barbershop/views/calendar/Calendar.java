...
public class Calendar implements Initializable {
    ...
    @FXML private HBox bottomMenu;
    @FXML private VBox rightMenu;
    @FXML private HBox leftMenu;
    @FXML private HBox calendarHead;
    @FXML private HBox calendarHead2;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        //innitialize the current month and year
        dateFocus = LocalDateTime.now();
        today = LocalDateTime.now();
        ...
        //show the calendar when calendareventsMap is innitialized
        drawCalendar();
    }
